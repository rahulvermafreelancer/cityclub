    ...
    <>
      <ScrollView>
        <View style={styles.loginContainer}>
          ...
          <View style={[styles.inputTexts, {marginTop: '11%'}]}>
          ...
          <View style={[styles.inputTexts]}>
            <View style={[{marginLeft: '5%'}]}>
              <FontAwesome name="at" style={styles.iconColor} />
            </View>
            <View style={styles.textfield}>
              <TextInput
          ...
          <View style={[styles.inputTexts]}>
            <View style={[{marginLeft: '5%'}]}>
              <FontAwesome name="calendar" style={styles.iconColor} />
            </View>
            <View style={styles.textfield}>
              <TextInput
          ...
          <TouchableOpacity
            ...
            <View style={styles.socialLogin}>
              <Image
                ...
                style={{margin: '2%'}}
              />
              <Text style={[styles.signupButtonText, {margin: '1%'}]}>
                Google
              </Text>
            </View>
          </TouchableOpacity>
